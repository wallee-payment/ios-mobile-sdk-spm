...
To use Apple Pay as a payment method, you must create a Merchant ID and the corresponding Apple Pay Payment Processing Certificate, then upload the certificate to the portal. In this section we will show you how to create a Merchant ID and how to get the certificate. If you do not want to use Apple pay you can ignore this section.
